...
library(tximeta)
dir <- "/fs/cbcb-lab/rob/students/noor/Uncertainity/boot_gibbs/quant_output/Drosophilla/sim_5e6"
source("/fs/cbcb-lab/rob/students/noor/Uncertainity/boot_gibbs/R/helper_func.R")
load("/fs/cbcb-lab/rob/students/noor/Uncertainity/ase-sim/sim_5e6/sim_counts_matrix.rda") ##True Counts
...
seSamp2 <- appTrueCounts(seSamp1, counts_matrix[,2])
```
